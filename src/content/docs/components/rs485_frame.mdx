...
[I][rs485_frame.discovery]:   Framing: DLE=0x10 STX=0x02 ETX=0x03  (start pair x412, end pair x412)
[I][rs485_frame.discovery]:   Escape: escape_byte 0x00 - 100% of 37 in-frame DLEs
[I][rs485_frame.discovery]:   CRC match: sum16 header_inclusive big-endian (unescaped) - 431/431 frames
